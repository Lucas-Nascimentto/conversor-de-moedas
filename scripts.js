...
const changeFirstImage = document.getElementById("first-select");
const changeSecondImage = document.getElementById("second-selected");
...
function changeImageOne() {
    const select = document.getElementById("initial-image-currency");

    if (changeFirstImage.value === "real") {
        select.src = "./assets/brasil 2.png"
    }

    if (changeFirstImage.value === "dolar") {
        select.src = "./assets/estados-unidos (1) 1.png"
    }

    if (changeFirstImage.value === "euro") {
        select.src = "./assets/euro.png"
    }

    if (changeFirstImage.value === "libra") {
        select.src = "./assets/libra 1.png"
    }

    if (changeFirstImage.value === "bitcoin") {
        select.src = "./assets/bitcoin 1.png"
    }

}

function changeImageTwo() {
    const select = document.getElementById("final-image-currency");

    if (changeSecondImage.value === "real") {
        select.src = "./assets/brasil 2.png"
    }

    if (changeSecondImage.value === "dolar") {
        select.src = "./assets/estados-unidos (1) 1.png"
    }

    if (changeSecondImage.value === "euro") {
        select.src = "./assets/euro.png"
    }

    if (changeSecondImage.value === "libra") {
        select.src = "./assets/libra 1.png"
    }

    if (changeSecondImage.value === "bitcoin") {
        select.src = "./assets/bitcoin 1.png"
    }
...
changeFirstImage.addEventListener("change", changeImageOne);
changeSecondImage.addEventListener("change", changeImageTwo);